...
/**
 *
 * Aug 15, 2016 12:08:49 PM
 *
 * @author Kevin V. Bui (kvb2@pitt.edu)
 */
public class GfciCli {

    private static final Logger LOGGER = LoggerFactory.getLogger(GfciCli.class);
    ...
    public static void main(String[] args) {
        if (args == null || args.length == 0 || Args.hasLongOption(args, "help")) {
            Args.showHelp("gFci", MAIN_OPTIONS);
            return;
        }
        ...
        System.out.println("================================================================================");
        System.out.printf("GFGS (%s)%n", DateTime.printNow());
        System.out.println("================================================================================");
        ...
        try (PrintStream writer = new PrintStream(new BufferedOutputStream(Files.newOutputStream(outputFile, StandardOpenOption.CREATE)))) {
            ...
            Graph graph = runGfci(dataSet, writer);
    ...
    private static Graph runGfci(DataSet dataSet, PrintStream writer) throws IOException {
        ...
        gFci.setFaithfulnessAssumed(heuristicSpeedup);
        gFci.setVerbose(verbose);
        if (knowledgeFile != null) {
            gFci.setKnowledge(IKnowledgeFactory.readInKnowledge(knowledgeFile));
        }
    ...
    private static void parseArgs(String[] args) {
        try {
            ...
            outputPrefix = cmd.getOptionValue("output-prefix", String.format("gFci_%s_%d", dataFile.getFileName(), System.currentTimeMillis()));
