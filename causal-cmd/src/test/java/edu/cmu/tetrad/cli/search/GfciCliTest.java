...
/**
 *
 * Aug 15, 2016 1:10:29 PM
 *
 * @author Kevin V. Bui (kvb2@pitt.edu)
 */
public class GfciCliTest {
    ...
    /**
     * Test of main method, of class GfciCli.
     *
     * @throws IOException
     */
    @Ignore
    ...
    public void testMain() throws IOException {
        ...
        String delimiter = "\t";
        String dirOut = tmpDir.newFolder("gfci").toString();
        String outputPrefix = "gfci";
